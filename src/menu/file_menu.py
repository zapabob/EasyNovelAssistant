...
class FileMenu:
    ...
    def on_menu_open(self):
        ...
        if self.ctx["recent_files"] and len(self.ctx["recent_files"]) > 0:  # 最近使ったファイル、のカスケードメニューadd_cascade
        ...
        if self.ctx["recent_dirs"] and len(self.ctx["recent_dirs"]) > 0:  # 最近使ったフォルダ、のカスケードメニューadd_cascade
